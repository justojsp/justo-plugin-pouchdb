...
catalog.workflow({name: "build", desc: "Build the package."}, function() {
  ...
  copy(
    "Create package",
    {
      ...
      dst: "dist/es5/nodejs/justo-plugin-pouchdb/"
    },
    {
      src: "build/es5/lib/",
      dst: "dist/es5/nodejs/justo-plugin-pouchdb/lib"
    },
    {
...
catalog.macro({name: "test", desc: "Unit test."}, {
  ...
  src: [
    "test/unit/index.js",
    "test/unit/lib/installServer.js",
    "test/unit/lib/startServer.js",
    "test/unit/lib/ping.js",
    "test/unit/lib/dump.js",
    "test/unit/lib/load.js",
    "test/unit/lib/uninstallServer.js"
  ]
});
...
catalog.workflow({name: "publish", desc: "NPM publish."}, function() {
  publish("Publish in NPM", {
    who: "justojs",
    src: "dist/es5/nodejs/justo-plugin-pouchdb/"
  });
});
